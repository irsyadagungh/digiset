...
import CardHero, { CardHeroProps } from "@/components/cardHero";

export default function Home() {
  const list: CardHeroProps[] = [
    {
      svg: <PadLock />,
    ...
    },
    {
      ...
      description:
        "Monitor the status and location of your assets in real time.",
    },
    {
      svg: <PadLock />,
      title: "Maximum Efficiency",
      description: "Save time and resources with automated digital processes.",
    },
    {
      svg: <PadLock />,
      title: "Centralized Asset Management",
      description: "Manage all your assets in one intuitive platform.",
    },
  ];
  ...
  return (
    ...
    >
      <nav className={`fixed z-10 w-full gap-2 py-4 px-16 flex justify-end`}>
        <button
          onClick={handleLogin}
          className={`text-lg border-blue border py-1 px-4 rounded-md`}
        >
          Login
        </button>
